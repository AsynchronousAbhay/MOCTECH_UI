...
var btn = document.querySelector(".home1-img")
var pulse = document.querySelector(".pulse")
var form = document.querySelector(".box1 .dets0")
var cross = document.querySelector(".box1 .cross")
var cross1 = document.querySelector(".img-slider h4")
var login = document.querySelector(".login-button")
var loginpage = document.querySelector(".login-container")
var hamburger = document.querySelector(".hamburger")
var toggler = document.querySelector(".toggler")
var togglerCross = document.querySelector(".togglerCross")
